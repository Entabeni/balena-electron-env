...
const CaptureRentalDetailsModalContainer = styled.div`
  min-height: 100%;
  position: relative;
  padding-top: 80px;
  padding-bottom: 60px;
...
export default function CaptureRentalDetailsModal({
  title,
  subTitle,
  children,
  addBorder,
  ...
  return (
    <Modal zIndex="1002" height="50%" width="70%">
      <CaptureRentalDetailsModalContainer>
        <ModalHeader>
          <div>
            <H2>{title}</H2>
        ...
        <ModalSection id="rentalDetailsModal" addBorder>
          {children}
        </ModalSection>
        <ModalFooter>
