...
console.log('🚀 ~ file: tokenService.js ~ line 44 ~ backendUrl', backendUrl)
var websocketUrl = 'wss://' + backendUrl + '/cable'
var macType = process.env.IS_WIFI || 'eth0'
var deviceMac = 'CA:2D:E9:8D:17:67'
var password = process.env.TERMINAL_PASSWORD || '0da2e47439437d10f47413227bfe3643'
var envPrintTerminalId = process.env.PRINT_TERMINAL_ID || 'c700e642-0bfe-4760-af09-104b59a49066'
var frontendUrl =
  'https://' + backendUrl + '/?frontEndUrl=https://' + process.env.FRONT_END_URL + '/' ||
  'https://entabeni-api-staging.herokuapp.com/?frontEndUrl=https://pos-demo.entabeni.tech/'
var SIGN_IN_TERMINAL_MUTATION = apollo_boost_1.gql(
  templateObject_1 ||
...
var TokenService = /** @class */ (function() {
  ...
  TokenService.prototype.initClient = function(baseUrl) {
    ...
    var cable = websocketUrl ? action_cable_node_1.default.createConsumer(websocketUrl, ws_1.default) : null
  ...
  TokenService.prototype.login = function(baseUrl, callback) {
    ...
    this.apolloClient
      ...
      .then(function(_a) {
        ...
        console.log('🚀 ~ file: tokenService.js ~ line 174 ~ .then ~ data', data)
